...
$project = Join-Path $root "dev/src/Bannerlord.HeroManagerEnhanced/Bannerlord.HeroManagerEnhanced.csproj"
$staging = Join-Path $root "out/Bannerlord.HeroManagerEnhanced"
...
$builtDll = Join-Path $root "dev/src/Bannerlord.HeroManagerEnhanced/bin/Release/Bannerlord.HeroManagerEnhanced.dll"
...
$pdbSrc = Join-Path $root "dev/src/Bannerlord.HeroManagerEnhanced/bin/Release/Bannerlord.HeroManagerEnhanced.pdb"
if (Test-Path $pdbSrc) {
    Copy-Item $pdbSrc $binDir -Force
}

$zipPath = Join-Path $root "out/Bannerlord.HeroManagerEnhanced-$Version.zip"
